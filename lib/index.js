...
const functions_1 = require("./agentica/functions");
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield server.open(port, (acceptor) => __awaiter(void 0, void 0, void 0, function* () {
        const url = new URL(`http://localhost${acceptor.path}`);
        const agent = new core_1.Agentica({
            ...
            histories: url.pathname === "/"
                ? []
                : yield getPromptHistories(url.pathname.slice(1)),
        });
